...
public class InternationalSignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_international_sign_up);
        ...
        loginRedirectArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InternationalSignUp.this, InternationalLogin.class);
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference = database.getReference("Internationals");
                ...
                Toast.makeText(InternationalSignUp.this,"You have signed Up successfully",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(InternationalSignUp.this,InternationalLogin.class));
            }
        });
